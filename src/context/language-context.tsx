...
export const strings: Translations = {
    ...
    bn: {
        ...
        salesOverviewDescription: 'গত এক বছরের বিক্রয়ের সারসংক্ষেপ।',
        ...
        agentInitialMessage: "নমস্কার! আমি স্মার্টবিজ লাইট এআই। আজ আপনার ব্যবসা বিশ্লেষণে আমি কীভাবে সাহায্য করতে পারি? আপনি আমাকে বিক্রয়, ইনভেন্টরি, গ্রাহক বা সাধারণ পরামর্শ সম্পর্কে জিজ্ঞাসা করতে পারেন।",
