...
const prompt = ai.definePrompt({
  ...
  ALWAYS answer in a friendly, conversational, and helpful tone. Your response must be in the Bangla language and tailored for a Bangladeshi audience. Keep responses concise and to the point unless asked for details.
