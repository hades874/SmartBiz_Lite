...
const salesForecastingPrompt = ai.definePrompt({
  ...
  prompt: `You are a business analyst for SMEs in Bangladesh. Analyze the provided sales data and provide a 30-day sales forecast for each product. Your response must be in the Bangla language and tailored for a Bangladeshi audience.
